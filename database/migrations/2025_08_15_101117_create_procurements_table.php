...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('procurement_product', function (Blueprint $table) {
            ...
            $table->integer('requested_tax_amount')->nullable();
            $table->integer('requested_supplier_percentage')->nullable();
            $table->integer('requested_supplier_price')->nullable();

            $table->integer('received_quantity')->nullable();
            $table->integer('received_unit_price')->nullable();
            $table->integer('received_tax_percentage')->nullable();
            $table->integer('received_tax_amount')->nullable();
            $table->integer('received_supplier_percentage')->nullable();
            $table->integer('received_supplier_price')->nullable();

            $table->integer('total_requested_unit_price')->virtualAs('requested_quantity * requested_unit_price');
            $table->integer('total_requested_supplier_price')->virtualAs('requested_quantity * requested_supplier_price');
            ...
            $table->integer('total_received_supplier_price')->virtualAs('received_quantity * received_supplier_price');
